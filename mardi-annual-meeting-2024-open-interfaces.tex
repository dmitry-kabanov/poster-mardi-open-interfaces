\documentclass[a0paper, twocolumn, csc, english]{mpi2015_poster}
...
\author[1]{Dmitry I.\ Kabanov}
\author[1]{Stephan Rave}
\author[1]{Mario Ohlberger}
\affil[1]{Institute for Analysis and Numerics, University of M\"{u}nster, M\"{u}nster, Germany}
